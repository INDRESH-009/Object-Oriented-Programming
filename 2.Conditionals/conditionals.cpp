/* TOPICS COVERED
        ...
        5.check wheather  character is a alphabet or not
...
//======================================== LECTURE - 03 ======================================
    //Take a  positive integer as input and check if it is a 3 digit number or not
    int a;
...
//======================================== LECTURE - 07 =========================================
    ...
    /* 
                    ...
                    what happens is that when we write the condition in if-else , it converts to a boolean value of true or false. If true only then the code block is executed.
